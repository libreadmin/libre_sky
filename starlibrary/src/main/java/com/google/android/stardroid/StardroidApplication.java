...
import com.libre.starlibrary.R;
 ...
 * @author John Taylor
 */
public class StardroidApplication {
    ...
    public void init(Application app) {
        ...
        PreferenceManager.setDefaultValues(instance, R.xml.preference_screen, false);
...
//  }
    ...
    public static String getVersionName() {
        ...
        try {
            PackageInfo info = packageManager.getPackageInfo(instance.getPackageName(), 0);
