...
public class ApplicationModule {
  ...
  Context provideContext() {
    return StardroidApplication.instance;
  }
  ...
  LocationManager provideLocationManager() {
    return ContextCompat.getSystemService(provideContext(), LocationManager.class);
  }
  ...
  AssetManager provideAssetManager() {
    return provideContext().getAssets();
  }
  ...
  SensorManager provideSensorManager() {
    return ContextCompat.getSystemService(provideContext(), SensorManager.class);
  }

  @Provides
  @Singleton
  ConnectivityManager provideConnectivityManager() {
    return ContextCompat.getSystemService(provideContext(), ConnectivityManager.class);
  }
